...
<body>
<style>:root{--acc:#22d3ee;--acc2:#818cf8;--bg:#070b16;--panel:#0e1626;--r:20px}body{font-family:'Inter',ui-sans-serif,system-ui,-apple-system,'Segoe UI',sans-serif!important;background:radial-gradient(900px 600px at 8% -10%,rgba(34,211,238,.12),transparent 60%),radial-gradient(820px 520px at 102% 0%,rgba(129,140,248,.14),transparent 55%),radial-gradient(760px 760px at 50% 120%,rgba(16,185,129,.10),transparent 60%),#070b16!important;background-attachment:fixed!important}.topbar{backdrop-filter:blur(18px) saturate(150%)!important;-webkit-backdrop-filter:blur(18px) saturate(150%)!important;background:rgba(7,11,22,.72)!important;border-bottom:1px solid rgba(120,150,220,.14)!important}.card{background:linear-gradient(180deg,rgba(22,34,60,.62),rgba(14,22,42,.62))!important;backdrop-filter:blur(18px) saturate(140%)!important;-webkit-backdrop-filter:blur(18px) saturate(140%)!important;border:1px solid rgba(120,150,220,.16)!important;border-radius:var(--r)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 24px 60px -22px rgba(0,0,0,.65)!important;transition:transform .25s ease,box-shadow .25s ease!important}.card:hover{transform:translateY(-2px)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 32px 72px -22px rgba(0,0,0,.75)!important}input,select,textarea{background:rgba(8,14,28,.6)!important;border:1px solid rgba(120,150,220,.18)!important;border-radius:12px!important}input:focus,select:focus,textarea:focus{border-color:var(--acc)!important;box-shadow:0 0 0 4px rgba(34,211,238,.18)!important;background:rgba(8,14,28,.85)!important}.btn{border-radius:12px!important;transition:.2s!important}.btn-pri{background:linear-gradient(135deg,var(--acc),var(--acc2))!important;box-shadow:0 10px 26px -8px rgba(34,211,238,.5)!important}.btn-pri:hover{filter:brightness(1.1)!important;transform:translateY(-1px)!important}.btn-sec{background:rgba(40,56,92,.5)!important;border:1px solid rgba(120,150,220,.2)!important}.btn-sec:hover{border-color:var(--acc)!important}.brand .logo,.login .logo,.side .brand .logo{box-shadow:0 8px 24px -6px rgba(34,211,238,.5)!important}.tabs button{border-radius:12px!important;border:1px solid rgba(120,150,220,.18)!important}.tabs button.active{background:linear-gradient(135deg,var(--acc),var(--acc2))!important;box-shadow:0 8px 20px -6px rgba(34,211,238,.45)!important;border-color:transparent!important}.side{background:rgba(10,16,32,.6)!important;backdrop-filter:blur(18px) saturate(140%)!important;-webkit-backdrop-filter:blur(18px) saturate(140%)!important;border-right:1px solid rgba(120,150,220,.14)!important}.side nav button{border-radius:12px!important}.side nav button.active{background:linear-gradient(135deg,rgba(34,211,238,.2),rgba(129,140,248,.2))!important;border:1px solid rgba(34,211,238,.35)!important}.login .box{background:linear-gradient(180deg,rgba(22,34,60,.8),rgba(14,22,42,.85))!important;backdrop-filter:blur(20px) saturate(150%)!important;-webkit-backdrop-filter:blur(20px) saturate(150%)!important;border:1px solid rgba(120,150,220,.18)!important;box-shadow:0 30px 80px -20px rgba(0,0,0,.7)!important}tbody tr:hover{background:rgba(34,211,238,.06)!important}.pill{background:rgba(34,211,238,.12)!important;color:#67e8f9!important;border:1px solid rgba(34,211,238,.3)!important}.dot{box-shadow:0 0 10px #34d399!important}pre{background:rgba(6,10,22,.7)!important;border:1px solid rgba(120,150,220,.16)!important;border-radius:12px!important;padding:.8rem 1rem!important}</style>
<div class="topbar">
...
<div class="app" id="app" style="display:none">
  ...
  <div class="content">
    ...
    <div class="tab" id="t-theme"><div class="card"><h2>🎨 Apariencia de la web</h2>
      ...
      <div class="row"><div><label>Color principal</label><input id="th_acc" type="color" value="#22d3ee"></div><div><label>Color secundario</label><input id="th_acc2" type="color" value="#818cf8"></div></div>
      <div class="row"><div><label>Fondo</label><input id="th_bg" type="color" value="#0a0f1e"></div><div><label>Panel</label><input id="th_panel" type="color" value="#0e1626"></div></div>
