          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed mt-1">
                Incluye <code className="text-emerald-400 font-mono">instalador.sh</code> y la carpeta{" "}
                <code className="text-emerald-400 font-mono">src/</code> completa (frontend + pocsag-server).
              </p>
            </div>
          </div>
          <motion.button
